...
$class_to_filter = 'wpb_single_image post-gallery wpb_content_element vc_align_' . $alignment . ' ' . $this->getCSSAnimation( $css_animation );
...
if ( 'yes' === $add_caption && '' !== $caption ) {
	$html .= '<span class="image-caption">' . esc_html( $caption ) . '</span>';
}
