...
<!-- block content -->
	...
	<div class="center-button">
		<a class="load-morem" href="#"  data-cat="<?php echo esc_attr($cat); ?>" data-load="<?php echo esc_attr($order); ?>" data-found="<?php echo esc_attr($portfolio->found_posts); ?>"><?php  esc_html_e('Show me More','hotmagazine'); ?></a>
	</div>
