...
<?php 
	if(is_page_template('template-boxed.php')){
		$body_class = 'boxed';
	}elseif($custom['body_style']=='dark'){
		$body_class = 'boxed dark';
	}else{
		$body_class = $custom['body_style'];
	}
?>
	...
	<div id="container">
		<?php 
		  if($custom['body_style']!='' and $custom['body_style']=='fashion' ){
		  	$header_layout = 'fashion';
		  }elseif($custom['body_style']!='' and $custom['body_style']=='sport' ){
		  	$header_layout = 'sport';
		  }elseif($custom['body_style']!='' and $custom['body_style']=='tech' ){
		  	$header_layout = 'tech';
		  }elseif($custom['body_style']!='' and $custom['body_style']=='design' ){
		  	$header_layout = 'design';
		  }elseif($custom['body_style']!='' and $custom['body_style']=='travel' ){
		  	$header_layout = 'travel';
		  }elseif($custom['body_style']!='' and $custom['body_style']=='politics' ){
		  	$header_layout = 'politics';
		  }else{
